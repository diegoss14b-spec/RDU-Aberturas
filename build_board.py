...
from mesa_shared import (  # contrato compartilhado com o mesa_bot (review 19/08)
    EV_MIN, EDGE_MIN, MARGIN_MIN, MARGIN_CAP, P_LO, P_HI,
    LEAGUE_FORA, FIXTURE_LABEL_COMP, de_vig, three_way,
)
...
# Limiares do gate: MOVIDOS pra mesa_shared.py (compartilhados com o mesa_bot).
...
# LEAGUE_FORA: MOVIDO pra mesa_shared.py (o juiz do mesa_bot aplica a mesma barreira).
...
# FIXTURE_LABEL_COMP: MOVIDO pra mesa_shared.py (era duplicado no juiz — driftaria).
...
# de_vig: MOVIDO pra mesa_shared.py.
...
# three_way: MOVIDO pra mesa_shared.py.
